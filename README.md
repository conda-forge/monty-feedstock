...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3126&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/monty-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `monty` can be installed with `conda`:
...
It is possible to list all of the versions of `monty` available on your platform with `conda`:
...
```
mamba search monty --channel conda-forge
```
...
mamba repoquery search monty --channel conda-forge

# List packages depending on `monty`:
mamba repoquery whoneeds monty --channel conda-forge

# List dependencies of `monty`:
mamba repoquery depends monty --channel conda-forge
```
